...
public class ExplodedBlockManager
{
     ...
     */
    private static final List<CreeperExplosion> explosionList = new LinkedList<CreeperExplosion>();
    /*
     ...
     */
    private static final List<Replaceable> brokenEntityList = new ArrayList<Replaceable>();
