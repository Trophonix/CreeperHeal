...
public class RailsIndex
{
     ...
     */
    private static final Map<CreeperRail, Date> railsIndex;
    ...
    public static boolean isUpdatePrevented(Block block) {
        return CreeperRail.RAIL_TYPES.contains(block.getType()) && railsIndex.containsKey(new CreeperRail(block.getState()));
    }
